...
- [Cleanup](https://github.com/thundercap/KubeProject/blob/main/README.md#step-12-cleanup)
...
3. **Clone Repository**: `git clone https://github.com/thundercap/KubeProject.git`
...
```sh
git clone https://github.com/thundercap/KubeProject.git
```
...
- **Issues**: [GitHub Issues](https://github.com/thundercap/KubeProject/issues)
